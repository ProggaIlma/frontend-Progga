...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    featuredBg: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&q=80",
    text: "",
    featured: true,
  },
  {
    ...
    <section id="testimonials" className="section-py" style={{ background: "var(--bg)" }}>
      <div className="container">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="h2 gsap-fade-up">Real Results from<br />Real People</h2>
        </div>
          ...
          {TESTIMONIALS.map((t, i) =>
            t.featured ? (
              ...
              <div
                key={i}
                data-card
                className="rounded-2xl overflow-hidden relative flex-shrink-0 flex flex-col justify-end"
                style={{
              ...
              >
                ...
                <div
                  className="absolute top-5 left-5 w-11 h-11 rounded-full overflow-hidden flex-shrink-0"
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                      <path d="M5 3.5l10 5.5-10 5.5V3.5z" fill="#1245B3" />
                    </svg>
                  </button>
                </div>
                ...
                <div className="relative z-10 p-5">
                  ...
                  <p className="text-xs mt-0.5" style={{ color: "rgba(255,255,255,0.6)" }}>{t.role}</p>
                </div>
              </div>
              ...
              <div
                key={i}
                data-card
                className="rounded-2xl p-6 flex flex-col justify-between flex-shrink-0"
                style={{
              ...
              >
                {/* Avatar */}
                <div
                  className="w-11 h-11 rounded-full overflow-hidden flex-shrink-0 mb-6"
                ...
                <div className="mt-6 pt-4" style={{ borderTop: "1px solid var(--border)" }}>
                  ...
                  <p className="text-xs mt-0.5" style={{ color: "var(--text2)" }}>{t.role}</p>
                </div>
              </div>
